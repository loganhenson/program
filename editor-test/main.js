...
var $author$project$Main$files = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('test.js', '\nlet mass = 5;\n\nfunction getFuelByMass(mass) {\n    return (mass / 3)\n}\n\nconsole.log(mass)\n        '),
			_Utils_Tuple2('test.php', '<?php\n$fn1 = fn($x) => $x + $y;\n\n$fn2 = function ($x) use ($y) {\n    return $x + $y;\n};\n\nfunction getFuelByMass($mass) {\n    return ($mass / 3)\n}'),
			_Utils_Tuple2('test.elm', 'module Editor.Mode.Insert.Handlers.DownArrow exposing (handle)\n\nimport Editor.Lib\nimport Editor.Msg\nimport Editor.VerticalMovement as VerticalMovement\n\n\nhandle : Editor.Msg.Model -> ( Editor.Msg.Model, Cmd Editor.Msg.Msg ) handle : Editor.Msg.Model -> ( Editor.Msg.Model, Cmd Editor.Msg.Msg )handle : Editor.Msg.Model -> ( Editor.Msg.Model, Cmd Editor.Msg.Msg )\nhandle model =\n   let\n       { x, y } =\n           Editor.Lib.currentCursorPosition model.travelable.cursorPositions\n\n               '),
			_Utils_Tuple2('test.json', '{\n     "type": "application",\n     "source-directories": [\n         "src",\n         "../src"\n     ],\n     "elm-version": "0.19.1",\n     "dependencies": {\n         "direct": {\n             "capitalist/elm-octicons": "2.3.0",\n             "elm/browser": "1.0.1",\n             "elm/core": "1.0.0",\n             "elm/html": "1.0.0",\n             "elm/http": "1.0.0",\n             "elm/json": "1.1.3",\n             "elm/regex": "1.0.0",\n             "elm-community/list-extra": "8.1.0",\n             "elm-community/string-extra": "4.0.0",\n             "hecrj/html-parser": "2.4.0"\n         },\n         "indirect": {\n             "elm/parser": "1.1.0",\n             "elm/svg": "1.0.1",\n             "elm/time": "1.0.0",\n             "elm/url": "1.0.0",\n             "elm/virtual-dom": "1.0.2",\n             "rtfeldman/elm-hex": "1.0.0"\n         }\n     },\n     "test-dependencies": {\n         "direct": {},\n         "indirect": {}\n     }\n}\n')
		]));
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{editor: $elm$core$Maybe$Nothing, file: $elm$core$Maybe$Nothing, files: $author$project$Main$files},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$EditorMsg = function (a) {
	return {$: 'EditorMsg', a: a};
};
var $author$project$Editor$Msg$ErrorsResponse = function (a) {
	return {$: 'ErrorsResponse', a: a};
};
var $author$project$Main$FileChanged = function (a) {
	return {$: 'FileChanged', a: a};
};
var $author$project$Editor$Msg$PasteResponse = function (a) {
	return {$: 'PasteResponse', a: a};
};
var $author$project$Editor$Msg$SaveResponse = function (a) {
	return {$: 'SaveResponse', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$map = _Platform_map;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Ports$receiveChange = _Platform_incomingPort('receiveChange', $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Ports$receiveErrors = _Platform_incomingPort('receiveErrors', $elm$json$Json$Decode$value);
var $author$project$Ports$receivePaste = _Platform_incomingPort('receivePaste', $elm$json$Json$Decode$string);
var $author$project$Ports$receiveSave = _Platform_incomingPort('receiveSave', $elm$json$Json$Decode$value);
var $author$project$Editor$Msg$RawKeyboardMsg = function (a) {
	return {$: 'RawKeyboardMsg', a: a};
};
var $author$project$Editor$Msg$WindowMouseUp = function (a) {
	return {$: 'WindowMouseUp', a: a};
};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Editor$Msg$RawKeyboardMsg,
				A2($author$project$Editor$RawKeyboard$subscriptions, true, false)),
				function () {
				var _v0 = model.selectionState;
				if (_v0.$ === 'Selecting') {
					return $elm$browser$Browser$Events$onMouseUp(
						A2(
							$elm$json$Json$Decode$map,
							$author$project$Editor$Msg$WindowMouseUp,
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Ports$receiveSave($author$project$Editor$Msg$SaveResponse)),
				A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$EditorMsg,
				$author$project$Ports$receivePaste($author$project$Editor$Msg$PasteResponse)),
				A2(
				$elm$core$Platform$Sub$map,
				$author$project$Main$EditorMsg,
				$author$project$Ports$receiveErrors($author$project$Editor$Msg$ErrorsResponse)),
				$author$project$Ports$receiveChange($author$project$Main$FileChanged),
				function () {
				...
				if (_v0.$ === 'Just') {
					...
					return A2(
						$elm$core$Platform$Sub$map,
						$author$project$Main$EditorMsg,
						$author$project$Editor$subscriptions(editor));
				} else {
					return $elm$core$Platform$Sub$none;
				}
			}()
...
var $author$project$Editor$Lib$getTravelableByFile = F2(
	function (file, model) {
		var _v0 = A2($author$project$Editor$Lib$getCurrentHistoryIndexAndHistoryByFile, file, model);
		if (_v0.$ === 'Just') {
			var _v1 = _v0.a;
			var index = _v1.a;
			var history = _v1.b;
			return A2($elm_community$list_extra$List$Extra$getAt, index, history);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Editor$Lib$loadNewFile = F3(
	function (model, file, contents) {
		...
		return _Utils_Tuple2(
			...
			A2($author$project$Editor$Lib$syncScrollPosition, travelable, model));
	});
...
var $author$project$Editor$Lib$changeFile = F3(
	function (model, file, contents) {
		var _v0 = A2($author$project$Editor$Lib$getTravelableByFile, file, model);
		if (_v0.$ === 'Nothing') {
			return A3($author$project$Editor$Lib$loadNewFile, model, file, contents);
		} else {
			var travelable = _v0.a;
			var nextTravelable = function () {
				var _v1 = _Utils_eq(
					contents,
					$author$project$Editor$Lib$renderableLinesToContents(travelable.renderableLines));
				if (_v1) {
					return travelable;
				} else {
					return _Utils_update(
...
var $author$project$Ports$requestChange = _Platform_outgoingPort('requestChange', $elm$json$Json$Encode$string);
...
var $author$project$Main$ports = {
	requestChange: function (contents) {
		return $author$project$Ports$requestChange(contents);
	},
	requestCompletion: function (_v0) {
		return $elm$core$Platform$Cmd$none;
	},
	requestCopy: $author$project$Ports$requestCopy,
	requestPaste: $author$project$Ports$requestPaste,
	requestRun: function (_v1) {
		return $elm$core$Platform$Cmd$none;
	},
	requestSave: function (_v2) {
		return $elm$core$Platform$Cmd$none;
	}
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'EditorMsg':
				...
				if (_v1.$ === 'Just') {
					var editor = _v1.a;
					var _v2 = A2($author$project$Editor$update, m, editor);
					var newEditor = _v2.a;
					var msgs = _v2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								editor: $elm$core$Maybe$Just(newEditor)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$EditorMsg, msgs));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'FileChanged':
			...
			case 'ActivateFile':
				...
				var _v4 = function () {
					...
					if (_v5.$ === 'Just') {
						var editor = _v5.a;
						return A3($author$project$Editor$Lib$changeFile, editor, file, contents);
					} else {
						return _Utils_Tuple2(
							A5(
								...
								file,
								contents,
								{padBottom: true, padRight: true, showCursor: true, showLineNumbers: true, vimMode: true},
								$author$project$Main$ports),
							$elm$core$Platform$Cmd$none);
					}
				}();
				var nextEditor = _v4.a;
				var msgs = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							editor: $elm$core$Maybe$Just(nextEditor),
...
var $author$project$Main$ActivateFile = F2(
	function (a, b) {
		return {$: 'ActivateFile', a: a, b: b};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex justify-around mb-6')
					]),
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											A2($author$project$Main$ActivateFile, file, contents))
										]),
									_List_fromArray(
										[
				...
				if (_v0.$ === 'Just') {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('h-64 w-128')
							]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$map,
								$author$project$Main$EditorMsg,
								$author$project$Editor$view(editor))
							]));
				} else {
					return $elm$html$Html$text('');
				}
